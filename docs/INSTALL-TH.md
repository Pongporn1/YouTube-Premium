...
## 5.1) ปุ่มบนแถบชื่อของหน้าต่าง (MyTubeMusic / mini player)

| ปุ่ม | ทำอะไร |
|---|---|
| ⚑ | สลับลอยด้านบนเสมอ (ลอยเหนือเกม/โปรแกรมอื่น) |
| ─ | พับจอลง taskbar (เพลงเล่นต่อ กดที่ taskbar เพื่อคืนหน้าต่าง) |
| ✕ | ปิดหน้าต่าง |
| ลากแถบชื่อ | ย้ายหน้าต่างไปวางตรงไหนก็ได้ ข้ามจอได้ |

คู่มือฉบับภาษาอังกฤษ: [INSTALL.md](INSTALL.md)
